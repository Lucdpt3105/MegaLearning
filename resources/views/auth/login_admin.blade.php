  ...
  <div class="auth-wrap">
    <div class="auth-card">
      <div class="brand">
        ...
        <div>
          <h1 class="title">Khu vực Quản trị 🔐</h1>
          <p class="sub">Chỉ dành cho quản trị viên hệ thống.</p>
        </div>
      </div>
      ...
      <form method="POST" action="{{ route('admin.login.post') }}" novalidate>
        ...
        <div class="input-wrap">
          ...
          <button type="button" class="pw-toggle" aria-label="Hiện/ẩn mật khẩu"
                  onclick="const i=document.getElementById('password');i.type=i.type==='password'?'text':'password';this.innerText=i.type==='password'?'Hiện':'Ẩn';">
            Hiện
          </button>
        </div>
        ...
        <button class="btn" type="submit">Đăng nhập quản trị</button>

        <p class="note">
          Người dùng thông thường? <a class="muted-link" href="{{ route('login') }}">Đăng nhập tại đây</a>
        </p>
      </form>
    </div>
  </div>
