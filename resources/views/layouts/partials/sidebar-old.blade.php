...
<aside id="sidebar" class="sidebar-container bg-gray-900 border-r border-gray-800 flex-shrink-0 overflow-visible transition-all duration-500 ease-in-out">
    <!-- Logo -->
    @php
        $dashboardUrl = '/';
        if (Auth::check()) {
    ...
    <a href="{{ $dashboardUrl }}" class="block p-4 mt-12">
        <div class="logo-container">
            ...
            <div class="logo-text">
                <h1 class="text-base font-semibold text-white">MegaLearning</h1>
        ...
        @auth
            @if(auth()->user()->hasRole('teacher'))
                ...
                <a href="{{ route('teacher.subjects.index') }}" class="sidebar-nav-item {{ request()->is('teacher/subjects*') ? 'active' : '' }}">
                    ...
                    <span class="nav-text">Môn học của tôi</span>
                </a>
                ...
                <a href="{{ route('teacher.video-calls.index') }}" class="sidebar-nav-item {{ request()->is('teacher/classes*') || request()->is('teacher/video-calls*') ? 'active' : '' }}">
                    ...
                    <span class="nav-text">Lớp học trực tuyến</span>
                </a>
                ...
                <a href="/teacher/documents" class="sidebar-nav-item {{ request()->is('teacher/documents*') ? 'active' : '' }}">
                    ...
                    <span class="nav-text">Tài liệu học tập</span>
                </a>
