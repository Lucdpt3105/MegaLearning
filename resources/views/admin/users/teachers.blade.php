...
@section('page-description', 'Quản lý tất cả tài khoản giáo viên thuộc hệ thống')
...
<div class="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
    <div class="bg-white p-6 rounded-2xl shadow border border-slate-100">
        <p class="text-sm text-slate-500">Tổng giáo viên</p>
...
<div class="bg-white rounded-2xl shadow border border-slate-100 p-6">
    ...
    <div class="flex items-center justify-between mb-4">
        <h3 class="text-lg font-semibold text-slate-800">Danh sách giáo viên</h3>
                        ...
                        <td class="px-4 py-3">
                            <div class="flex items-center gap-2 justify-end">
                                ...
                                <form action="{{ route('admin.users.destroy', $user->id) }}" method="POST"
                                      onsubmit="return confirm('Xóa giáo viên này? Hành động không thể hoàn tác!');"
                                      class="inline-block">
                                    @csrf
                                    @method('DELETE')
                                    <button type="submit"
