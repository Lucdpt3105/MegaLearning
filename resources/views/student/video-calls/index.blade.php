                            ...
                            <div class="flex-1">
                                ...
                                <div class="space-y-2">
                                    <div class="flex items-center text-sm text-gray-700">
                                        ...
                                        {{ $call->classRoom && $call->classRoom->subject ? $call->classRoom->subject->name : 'N/A' }}
                                    </div>
                                    <div class="flex items-center text-sm text-gray-700">
                                        <svg class="w-4 h-4 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M16 7a4 4 0 11-8 0 4 4 0 018 0zM12 14a7 7 0 00-7 7h14a7 7 0 00-7-7z"/>
                                        </svg>
                                        {{ $call->host ? $call->host->name : 'Host' }}
                                    </div>
                                    <div class="flex items-center text-sm text-gray-700">
                                        <svg class="w-4 h-4 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 8v4l3 3m6-3a9 9 0 11-18 0 9 9 0 0118 0z"/>
                            ...
                            <div class="flex-1 p-6">
                                ...
                                <div class="grid grid-cols-2 md:grid-cols-4 gap-4">
                                    <div class="flex items-center gap-2 text-sm">
                                        ...
                                        <span class="text-gray-700 font-medium truncate">{{ $call->classRoom && $call->classRoom->subject ? $call->classRoom->subject->name : 'N/A' }}</span>
                                    </div>
                                    ...
                                    <div class="flex items-center gap-2 text-sm">
                                        ...
                                        <span class="text-gray-700 font-medium truncate">{{ $call->host ? $call->host->name : 'Host' }}</span>
                                    </div>
                                    ...
                                    <div class="flex items-center gap-2 text-sm">
                                        ...
                                        <span class="text-gray-700 font-medium truncate">{{ $call->classRoom ? $call->classRoom->name : 'N/A' }}</span>
                                    </div>
                                </div>
                            </div>
