                        ...
                        <tr class="border-b border-gray-50 hover:bg-blue-50/30 transition-colors {{ $index % 2 === 0 ? 'bg-white' : 'bg-gray-50/50' }}">
                            ...
                            <td class="px-6 py-5">
                                <div class="flex items-center gap-2">
                                    ...
                                    <div>
                                        <div class="text-sm font-medium text-gray-900">{{ $class->subject ? $class->subject->name : 'N/A' }}</div>
                                        <div class="text-xs text-gray-500 mt-0.5">{{ $class->subject ? $class->subject->code : '' }}</div>
                                    </div>
                                </div>
                            </td>
